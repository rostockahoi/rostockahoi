...
$data = array(
	'title' => 'Rostock Ahoi | Impressum',
	'bodyClass' => 'legal-page',
	'contents' => '<h1>Impressum</h1> <h2>Angaben gem&auml;&szlig; &sect; 5 TMG:</h2> <p>Johannes Ahrndt<br />
Budapester Str. 61<br /> 18057 Rostock </p> <h2>Kontakt:</h2> <table><tr><td>Telefon: </td>
<td>+491622153898</td></tr> <tr><td>E-Mail: </td> <td><span id="obf"><script>document.getElementById("obf").innerHTML="<n uers=\"znvygb:uryyb@ebfgbpx-nubv.qr\" gnetrg=\"_oynax\">Xbagnxg</n>".replace(/[a-zA-Z]/g,function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);});</script>
<noscript><span style="unicode-bidi:bidi-override;direction:rtl;">ed.ioha-kcotsor@olleh</span></noscript>
</span></td> </tr>
</table> <h2>Verantwortlich f&uuml;r den Inhalt nach &sect; 55 Abs. 2 RStV:</h2> <p>Johannes
Ahrndt<br /> Budapester Str. 61<br /> 18057 Rostock</p> <p>Wir sind nicht bereit oder verpflichtet, an
...
entfernen.</p> <h2>Haftung f&uuml;r Links</h2> <p>Unser Angebot enth&auml;lt Links zu externen Webseiten Dritter, auf deren Inhalte wir keinen Einfluss haben. Deshalb k&ouml;nnen wir f&uuml;r diese
